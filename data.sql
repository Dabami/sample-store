...
('aaaaaaa1-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Espresso Coffee', 3.50, '22222222-2222-2222-2222-222222222222', 'espresso.jpg'),
('aaaaaaa2-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Green Tea', 3.00, '22222222-2222-2222-2222-222222222222', 'green_tea.jpg'),
('aaaaaaa3-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Mineral Water', 2.50, '33333333-3333-3333-3333-333333333333', 'mineral_water.jpg'),
('aaaaaaa4-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Cola Soda', 3.00, '33333333-3333-3333-3333-333333333333', 'cola_soda.jpg'),
('aaaaaaa5-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Chocolate Cookies', 2.00, '55555555-5555-5555-5555-555555555555', 'chocolate_cookies.jpg'),
('aaaaaaa6-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Mixed Nuts', 3.50, '66666666-6666-6666-6666-666666666666', 'mixed_nuts.jpg');
...
('bbbbbbb1-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'OPEN', 6.50, '4111111111111111', 'PENDING', NULL, 'Stripe', 'buyer1@example.com', 'A', 5),
('bbbbbbb2-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'FINISHED', 8.00, '5500000000000004', 'PAID', '2024-12-01', 'PayPal', 'buyer2@example.com', 'B', 12);
